      ...
      <div className="mx-auto flex h-[76px] w-[94vw] items-center px-4 sm:px-6 lg:px-0">
        ...
        <div className="ml-8 hidden items-center gap-6 lg:flex">
          <Link
            ...
            className="text-[#333] transition hover:text-[#079447]"
          >
            <UserRound size={23} />
          </Link>
          <Link
          ...
          <Link
            ...
            className="relative text-[#333] transition hover:text-[#079447]"
        ...
        <nav className="space-y-1 px-5 py-4">
          {[
            ...
            <NavLink
              ...
              className="block border-b border-gray-100 py-3 text-gray-700 hover:text-[#079447]"
            >
              {label}
            </NavLink>
          ))}
